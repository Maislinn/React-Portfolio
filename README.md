...
[![Features](https://img.shields.io/badge/Features-REACT-pink)](https://legacy.reactjs.org/docs/getting-started.html)
## Description
```text
...
```
In this project I was able to practice my tests and React skills.
